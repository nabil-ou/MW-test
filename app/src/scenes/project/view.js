    ...
    <div className="flex flex-wrap gap-3">
      ...
      {project.links?.map((link) => (
        <div key={link.url} className="group text-sm font-medium	text-blue-700 border-[1px] border-blue-700 rounded-full overflow-hidden">
          <a target="blank" href={normalizeUrl(link.url)} className="break-words cursor-pointer text-blue-700 hover:text-white hover:bg-blue-700 flex hover:no-underline h-full">
